...
export default function Pricing({ documentId: propDocumentId }) {
  ...
  return (
    <section
      id="pricing"
      className="py-24 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto scroll-mt-16 relative overflow-hidden font-sans text-on-surface"
    >
      ...
      {isSubscribed && (
        <div className="mb-10 max-w-3xl mx-auto bg-emerald-50 border-2 border-emerald-300 p-6 rounded-2xl shadow-sm flex items-start gap-4 animate-fade-in relative z-10">
      ...
      <div className="text-center mb-16 space-y-4 relative z-10">
        <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-indigo-50 border border-indigo-200 text-indigo-700 font-label-sm text-label-sm mb-2 select-none">
          <span
        ...
        <h2 className="text-headline-lg font-headline-lg text-academic-navy">
          {documentId ? 'Choose how to unlock this document' : 'Simple, Student-Friendly Pricing'}
        </h2>
      ...
      <div className="grid lg:grid-cols-[1fr_auto_1fr] gap-12 items-start relative z-10">
        {/* OPTION A: SUBSCRIBE */}
        <section className="space-y-8 order-1">
          ...
          <div className="grid sm:grid-cols-2 gap-6">
            {/* Monthly Card */}
            <div className="glass-card p-6 rounded-2xl shadow-sm border border-outline-variant hover:border-primary/40 transition-all flex flex-col justify-between bg-white">
              <div>
                <div className="mb-4">
        ...
        <section className="space-y-8 order-3 lg:pt-0 pt-8">
          ...
          <div className="glass-card relative p-8 rounded-2xl border-2 border-dashed border-primary/30 overflow-hidden shadow-sm bg-white">
          ...
          <div className="p-6 bg-blue-50/70 rounded-2xl border border-blue-100 flex items-start gap-4 shadow-sm">
            ...
            <p className="text-body-sm text-blue-900 leading-relaxed">
              <strong className="text-academic-navy">Institutional Access:</strong> Students from partner institutions with <code className="bg-blue-100 px-1.5 py-0.5 rounded font-mono text-xs text-blue-950">@cps.edu.np</code> emails always get free access — no subscription or upload needed. Just sign in with your student ID.
            </p>
          </div>
        </section>
      </div>
      ...
      {documentId && (
        <div className="mt-20 glass-card p-6 rounded-2xl flex flex-col md:flex-row items-center justify-between border border-outline-variant/50 max-w-4xl mx-auto shadow-md gap-4 bg-white relative z-10">
