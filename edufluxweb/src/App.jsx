    ...
    <ToastProvider>
      <BrowserRouter>
        <Routes>
          ...
          />
          <Route
            path="/subscription/esewa/callback"
            element={<PaymentCallback provider="esewa" />}
          />
          <Route
            path="/subscription/failed"
            element={<PaymentCallback isFailure={true} />}
          />
          <Route path="/documents/:id/view" element={<DocumentViewer />} />
          <Route
            path="/documents/preview-comparison"
            element={<DocumentViewerComparison />}
          />
